...
Tutorial from Clear Code Youtube Channel
Note: In order to open the files, make sure you write the absolute paths of the files in your computer.
"""
...
bgSurface = pygame.image.load('Learn Python by building games series/Flappy Bird/background-day.png').convert() # The background of the game screen
...
floorSurface = pygame.image.load('Learn Python by building games series/Flappy Bird/base.png').convert()
#floorSurface = pygame.transform.scale2x(floorSurface)
floorXPos = 0

'''
birdDownflap = pygame.transform.scale2x(pygame.image.load('Learn Python by building games series/Flappy Bird/bluebird-downflap.png').convert_alpha())
birdMidflap = pygame.transform.scale2x(pygame.image.load('Learn Python by building games series/Flappy Bird/bluebird-midflap.png').convert_alpha())
birdUpflap = pygame.transform.scale2x(pygame.image.load('Learn Python by building games series/Flappy Bird/bluebird-upflap.png').convert_alpha())
'''
birdDownflap = pygame.image.load('Learn Python by building games series/Flappy Bird/bluebird-downflap.png').convert_alpha()
birdMidflap = pygame.image.load('Learn Python by building games series/Flappy Bird/bluebird-midflap.png').convert_alpha()
birdUpflap = pygame.image.load('Learn Python by building games series/Flappy Bird/bluebird-upflap.png').convert_alpha()
...
'''
birdSurface = pygame.image.load('Learn Python by building games series/Flappy Bird/bluebird-midflap.png').convert()
#birdSurface = pygame.transform.scale2x(floorSurface)
birdRect = birdSurface.get_rect(center = (50, 256))
'''

pipeSurface = pygame.image.load('Learn Python by building games series/Flappy Bird/pipe-green.png').convert()
...
gameOverSurface = pygame.image.load('Learn Python by building games series/Flappy Bird/message.png').convert_alpha()
#gameOverSurface = pygame.transform.scale2x(gameOverSurface)
gameOverRect = gameOverSurface.get_rect(center = (144, 256))

flapSound = pygame.mixer.Sound('Learn Python by building games series/Flappy Bird/wing.wav')
deathSound = pygame.mixer.Sound('Learn Python by building games series/Flappy Bird/hit.wav')
scoreSound = pygame.mixer.Sound('Learn Python by building games series/Flappy Bird/point.wav')
